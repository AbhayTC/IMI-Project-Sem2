...
# _TorchModelWrapper and PolymerMLP must be importable here so that pickle can
# deserialise qspr_model_mlp.pkl — they are defined in task2_qspr_modeling.py.
try:
    from task2_qspr_modeling import _TorchModelWrapper, PolymerMLP  # noqa: F401
except ImportError as e:
    raise ImportError(
        "Cannot load qspr_model_mlp.pkl — make sure task2_qspr_modeling.py "
        "is in the same directory and has been run at least once.\n"
        f"Original error: {e}"
    )
